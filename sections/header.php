...
<!-- Main stylesheet imports bootstrap css and adds custom -->
    <link href="https://hack-12-plan.herokuapp.com/css/style.css" rel="stylesheet">
     <script src="//ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
  	<script>window.jQuery || document.write('<script src="https://hack-12-plan.herokuapp.com/js/jquery-1.7.1.min.js"><\/script>')</script>
...
<!-- Modernizr for browser feature-checking 
  	...
  	<script src="https://hack-12-plan.herokuapp.com/js/modernizr-2.5.3.min.js"></script>
